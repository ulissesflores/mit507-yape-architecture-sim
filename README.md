...
mit507-yape-architecture-sim/
    ├── src/
    │   └── simulation.py       # The core SimPy logic (well-documented)
    ├── notebooks/
    │   └── analysis.ipynb      # Jupyter Notebook for visualization
    ├── data/                   # Synthetic logs generated by the sim
    ├── requirements.txt        # Reproducibility dependencies
    ├── CITATION.cff            # Academic citation format
    └── https://www.google.com/search?q=LICENSE                 # Apache 2.0
...
## 📊 Results & Hypothesis
The simulation demonstrates that under high load (λ>μ):
